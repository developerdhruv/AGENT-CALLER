...
class MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        self.label = QLabel("Welcome to the Librarian Assistant!")
        ...
        video_url = QUrl.fromLocalFile("avatar.mp4")  # Replace with your video file path
        self.mediaPlayer.setMedia(QMediaContent(video_url))
        self.mediaPlayer.setVideoOutput(self.videoWidget)

    def start_listening(self):
        self.worker = Worker(self.conversation_manager)
        self.worker.result_signal.connect(self.update_ui_with_llm_response)
        self.worker.tts_signal.connect(self.speak_text)
        self.worker.start()
